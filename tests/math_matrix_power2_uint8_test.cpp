...
TEST(matrix_test, matrix_power_of_2_uint8)
{
    testMul<std::uint8_t, 2>();
    testMul<std::uint8_t, 4>();
    testMul<std::uint8_t, 8>();
    testMul<std::uint8_t, 16>();
    testMul<std::uint8_t, 32>();
    testMul<std::uint8_t, 64>();
    testMul<std::uint8_t, 128>();
    // testMul<std::uint8_t, 256>();
    // testMul<std::uint8_t, 512>();
    // testMul<std::uint8_t, 1024>();
}
